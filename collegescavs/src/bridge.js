...
const products = [
    ...
    { id: 2, title: 'Smartphone', price: 499, description: 'A sleek and modern smartphone', image: '../assets/phone.png', ratings: 1, category: 'Electronics' },
    { id: 3, title: 'Headphones', price: 199, description: 'Noise-cancelling over-ear headphones', image: '../assets/headphones.jpg', ratings: 0, category: 'Accessories' },
    ...
    { id: 6, title: 'Smartwatch', price: 150, description: 'Track your fitness with this sleek smartwatch', image: '../assets/phone.png', ratings: 5, category: 'Accessories' },
    { id: 7, title: 'Bluetooth Speaker', price: 89, description: 'Portable speaker with great sound quality', image: '../assets/phone.png', ratings: 3.8, category: 'Electronics' },
    ...
    { id: 11, title: 'Electric Scooter', price: 499, description: 'Ride in style with this electric scooter', image: '../assets/phone.png', ratings: 1.7, category: 'Electronics' },
    { id: 12, title: 'Bluetooth Earbuds', price: 120, description: 'High-quality sound in a compact design', image: '../assets/phone.png', ratings: 5, category: 'Accessories' },
    { id: 13, title: 'E-Reader', price: 129, description: 'Carry thousands of books in a compact device', image: '../assets/phone.png', ratings: 3.8, category: 'Electronics' },
    { id: 14, title: 'Drone', price: 799, description: 'Capture stunning aerial shots with this drone', image: '../assets/phone.png', ratings: 1.6, category: 'Electronics' },
    ...
    { id: 15, title: 'Very long title to test the styles of Projector', price: 350, description: 'Project your media onto any surface for a cinematic experience', image: '../assets/phone.png', ratings: 4.6, category: 'Electronics' }
